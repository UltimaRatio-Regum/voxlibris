...
const sentimentColors: Record<string, string> = {
  ...
  happy: "bg-green-500/10 text-green-700 dark:text-green-400 border-green-500/20",
  ...
  fear: "bg-purple-500/10 text-purple-700 dark:text-purple-400 border-purple-500/20",
  disgust: "bg-lime-500/10 text-lime-700 dark:text-lime-400 border-lime-500/20",
  surprise: "bg-amber-500/10 text-amber-700 dark:text-amber-400 border-amber-500/20",
  excited: "bg-yellow-500/10 text-yellow-700 dark:text-yellow-400 border-yellow-500/20",
  calm: "bg-teal-500/10 text-teal-700 dark:text-teal-400 border-teal-500/20",
  anxious: "bg-rose-500/10 text-rose-700 dark:text-rose-400 border-rose-500/20",
  hopeful: "bg-cyan-500/10 text-cyan-700 dark:text-cyan-400 border-cyan-500/20",
  melancholy: "bg-indigo-500/10 text-indigo-700 dark:text-indigo-400 border-indigo-500/20",
  tender: "bg-pink-500/10 text-pink-700 dark:text-pink-400 border-pink-500/20",
  proud: "bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 border-emerald-500/20",
